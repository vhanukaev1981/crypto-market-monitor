...
for (const segment of eligible) {
  ...
  const funnel=summarizeSignalFunnel(result.signalFunnelEvents);
  segmentAnalyses.push({
    ...
    signalEvaluationCount:result.signalFunnelEvents.length,
    funnel,
  });
}

const summary={
  engine:'ALGO_V2_BYBIT_SIGNAL_FUNNEL_V1_2',
  symbol,
  parameters:{
    ...parameters,
